 ...
 *
 * ⚠️⚠️ ДАРААЛАЛ = ЗАХИАЛАГЧИЙН ЭРЭМБЭ (2026-09-09). Массивын дараалал нь
 * ЗҮҮН баганад ЯГ ТЭР дарааллаар харагдана (`BranchedMegaPanel` нь эрэмбэ
 * хийдэггүй), мөн мобайлын хоёр рендерт ч ижил. Тиймээс эрэмбэ солих =
 * ЗӨВХӨН энэ массивын мөрүүдийг зөөх:
 *
 *   1. Багц                  (`packages`)
 *   2. Гэр интернет          (`home-internet`)
 *   3. Олон улсын үйлчилгээ  (`international`)
 *   4. For Foreigners        (`foreigners`)
 *   5. Нэмэлт дата           (`extra-data`)
 *   6. Нэмэлт үйлчилгээ      (`addons`)
 *
 * ⚠️ ӨМНӨ НЬ "Нэмэлт дата багц" 2-Р байрлалд байсныг 5-Р болгож зөөв —
 * захиалагчийн эрэмбэд нэмэлт үйлчилгээнүүд ХАМГИЙН СҮҮЛД байна.
 *
 * ⚠️ ШОШГО СОЛИОГҮЙ. Захиалагч эрэмбийг "Багц … Нэмэлт дата" гэж ХУРААСАН
 * нэрээр бичсэн боловч тэр нь дараалал заасан бичлэг, шошгын засвар БИШ —
 * "Үндсэн багцууд" (захиалагч өөрөө 09-08-нд ингэж сольсон) ба "Нэмэлт дата
 * багц" нь хэвээр. Шошгыг хураах бол тусад нь хэлэх шаардлагатай.
 */
const unitelBranches: MegaMenuBranch[] = [
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "smart-days", title: "Smart Days", href: "/#" },
        ],
      },
    ],
  },
  /**
   * ГЭР ИНТЕРНЕТ — дэд ангилал нь захиалагчийн 2026-09-09-ны screenshot-оос
   * БУУЛГАСАН, шинэ нэр ЗОХИООГҮЙ.
   *
   * "Дараа төлбөрт | Урьдчилсан төлбөрт" гэсэн таб бүхий төхөөрөмжийн
   * хуудас. ИДЭВХТЭЙ "Дараа төлбөрт" таб дээр хоёр карт харагдсан:
   *     5G Гэр интернет төхөөрөмж   — 400'000 төг
   *     4.5G Гэр интернет төхөөрөмж — 450'000 төг
   * Хоёуланд "Дараа төлбөрт үйлчилгээний гэрээ байгуулан төхөөрөмж авна"
   * гэсэн тайлбартай ⇒ эдгээр нь ДАРАА ТӨЛБӨРТ-ийн төхөөрөмж.
   *
   * ⚠️ ҮНЭ (400'000 / 450'000) ЦЭСЭНД ОРООГҮЙ. `MegaMenuSection` нь
   * `{id,title,href}` — навигаци нь НЭР харуулдаг, үнэ биш. Үнэ нь тухайн
   * хуудсанд харагдана.
   *
   * ⚠️ "Урьдчилсан төлбөрт" табын төхөөрөмжийн жагсаалт SCREENSHOT-Д
   * БАЙХГҮЙ тул ХОЁР ДАХЬ бүлэг бичээгүй. Тэр таб дээрх нэрсийг өгвөл
   * "Багцууд"-тай ижил Дараа/Урьдчилсан хос болно.
   *
   * ⚠️⚠️ "ҮЙЛЧИЛГЭЭ" БҮЛЭГ ХАСАГДСАН (2026-09-09, захиалагчийн шийдвэр).
   * Хоёр дахь screenshot-оос буулгасан 4 мөр байсан:
   *     Данс шалгах, цэнэглэх · Нэр шилжүүлэх · Гэр суурин утас ·
   *     Админ дугаар солих
   *
   * ЯАГААД: эдгээр нь AFTER-SERVICE буюу ДАНСАН ДЭЭР ҮЙЛДЭЛ хийдэг
   * функцууд. Захиалагчийн зорилт нь тэднийг цэсний ХАМГИЙН ЭХЭНД ИЛ
   * харуулахгүй, харин хэрэглэгчийг ЗААВАЛ НЭВТРҮҮЛЖ байж үйлдэл
   * хийлгэх. Тиймээс нээлттэй навигацид тэдгээрийг тавихгүй.
   *
   * ⚠️ ЭНЭ НЬ ЗАРЧИМ, зөвхөн энэ мөрийн засвар БИШ: цаашид ямар ч
   * ангилалд "данс", "төлбөр", "шилжүүлэх", "солих", "миний …" зэрэг
   * НЭВТРЭЛТ шаардсан үйлдлийг mega menu / burger-т нэмэхгүй. Тэдгээр нь
   * нэвтэрсний дараах хэсэгт (профайл / self-care) байрлана.
   */
  {
    id: "home-internet",
    title: "Гэр интернет",
   ...
   * ОЛОН УЛСЫН ҮЙЛЧИЛГЭЭ.
   *
   * ⚠️ ДЭД ЭЛЕМЕНТҮҮД ХАСАГДСАН (2026-09-09, захиалагчийн заавар). Өмнө нь
   * screenshot-оос буулгасан хоёр мөр байв:
   *     Роуминг үйлчилгээ · Олон улсын яриа мессэж
   * Тэдгээрийн замууд `#` (бэлэн болоогүй) байсан тул хагас бэлэн жагсаалт
   * харуулахын оронд БҮХЭЛД НЬ maintain статус болгов. Нэрсийг сэргээх бол
   * git-ээс — `groups` буцаахад `status`-ыг хамт авах эсэхийг шийднэ.
   */
  {
    id: "international",
  ...
  /**
   * FOR FOREIGNERS — unitel.mn-ийн ЖИНХЭНЭ хуудас (2026-09-09, захиалагч).
   *
   * ⚠️ `?_gl=1*…*_gcl_au*…` ПАРАМЕТР ХАСАГДСАН. Захиалагчийн ирүүлсэн хаягт
   * тэр нь байсан боловч `_gl` / `_gcl_au` нь Google Analytics-ийн
   * cross-domain linker-ийн ТҮР ЗУУРЫН тэмдэг — тухайн хүний тухайн
   * сессийн client id. Кодод шигтгэвэл БҮХ хэрэглэгч нэг хүний session
   * id-г дагаж, аналитик бохирдох ба параметр нь хугацаа дуусмагц утгагүй
   * болно. Каноник хаяг нь параметргүй хувилбар.
   *
   * ⚠️ Замын бичиглэл `/toursim/` — "tourism" БИШ. Захиалагчийн ирүүлсэн
   * хаягт ЯГ ингэж бичигдсэн (сайт дээрх бодит зам) тул "зассан" бол 404
   * болно. Хэрэв тэр нь unitel.mn дээрх үсгийн алдаа бөгөөс дараа
   * `/tourism/` болж зассан бол ЭНД БАС засах шаардлагатай.
   *
   * `http`-ээр эхэлдэг тул `MegaBranchRow` нь шинэ tab-аар нээж, ↗ тэмдэг
   * харуулна (дэд агуулгагүй тул `ChevronRight` БИШ).
   */
  {
    id: "foreigners",
    title: "For Foreigners",
    href: "https://unitel.mn/toursim/",
    status: "maintenance",
  },
  // ⚠️ Доорх 2 мөрийн дэд агуулга БЭЛЭН БОЛООГҮЙ — `groups` нэмэхэд баруун
  // панел тэр дороо ажиллана, компонент хөндөгдөхгүй. `status` тул
  // тэр хүртэл хэрэглэгчид "maintain хийгдэж байгаа" гэж ил хэлнэ.
  { id: "extra-data", title: "Нэмэлт дата багц", href: "#", status: "maintenance" },
  { id: "addons", title: "Нэмэлт үйлчилгээ", href: "#", status: "maintenance" },
];
