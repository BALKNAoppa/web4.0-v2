 ...
 */
export const TRENDING_TOPIC_PLACEHOLDER = "Их хайгдсан сэдэв {n} энд байрлана";
...
/**
 * Хэдэн чип харуулах вэ. 5 = md+ дээр 3 багана × 2 мөр (сүүлийн нүд хоосон).
 *
 * ⚠️ Энэ тоо `TrendingTopics`-ийн grid-тэй ХОЛБООТОЙ: 6-аас өсгөвөл 3 дахь
 * мөр гарч, туслах эхний дэлгэцээс халина. Бодит дата ирэхэд `topics.length`
 * болох ба тэр үед ч эхний 5-г л харуулна.
 */
