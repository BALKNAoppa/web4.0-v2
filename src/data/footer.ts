 ...
 *   НЭМЭГДСЭН             → "Тусламж"
 *
 * ⚠️ "Тусламж" 2026-09-16-НД БУЦААД ХАСАГДСАН (захиалагч: "footer дээрх
 * тусламж хэсгийг хас"). Мөр нь desktop ба мобайл ХОЁУЛАНД нь энэ нэг
 * массиваас уншигддаг тул хасалт хоёуланд нэг зэрэг үйлчилнэ.
